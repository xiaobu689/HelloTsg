...
output_directory = r'E:\script_tool\UnpackMiniApp\wxpack\1'
...
for wxapkg_file in wxapkg_files:
    ...
    print(wxapkg_path)
    os.system(
        f'node E:\\script_tool\\wxappUnpacker\\wuWxapkg.js {wxapkg_path} -s=E:\\script_tool\\UnpackMiniApp\\wxpack\\1')
